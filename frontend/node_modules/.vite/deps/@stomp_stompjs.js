//#region node_modules/@stomp/stompjs/esm6/augment-websocket.js
/**
* @internal
*/
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/byte.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/frame-impl.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/parser.js
/**
* @internal
*/
var NULL = 0;
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/types.js
/**
* Possible states for the IStompSocket
*/
var StompSocketState;
(function(StompSocketState$1) {
	StompSocketState$1[StompSocketState$1["CONNECTING"] = 0] = "CONNECTING";
	StompSocketState$1[StompSocketState$1["OPEN"] = 1] = "OPEN";
	StompSocketState$1[StompSocketState$1["CLOSING"] = 2] = "CLOSING";
	StompSocketState$1[StompSocketState$1["CLOSED"] = 3] = "CLOSED";
})(StompSocketState || (StompSocketState = {}));
/**
* Possible activation state
*/
var ActivationState;
(function(ActivationState$1) {
	ActivationState$1[ActivationState$1["ACTIVE"] = 0] = "ACTIVE";
	ActivationState$1[ActivationState$1["DEACTIVATING"] = 1] = "DEACTIVATING";
	ActivationState$1[ActivationState$1["INACTIVE"] = 2] = "INACTIVE";
})(ActivationState || (ActivationState = {}));
/**
* Possible reconnection wait time modes
*/
var ReconnectionTimeMode;
(function(ReconnectionTimeMode$1) {
	ReconnectionTimeMode$1[ReconnectionTimeMode$1["LINEAR"] = 0] = "LINEAR";
	ReconnectionTimeMode$1[ReconnectionTimeMode$1["EXPONENTIAL"] = 1] = "EXPONENTIAL";
})(ReconnectionTimeMode || (ReconnectionTimeMode = {}));
/**
* Possible ticker strategies for outgoing heartbeat ping
*/
var TickerStrategy;
(function(TickerStrategy$1) {
	TickerStrategy$1["Interval"] = "interval";
	TickerStrategy$1["Worker"] = "worker";
})(TickerStrategy || (TickerStrategy = {}));

//#endregion
//#region node_modules/@stomp/stompjs/esm6/ticker.js
var Ticker = class {
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/versions.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/stomp-handler.js
/**
...
var StompHandler = class {
	...
	forceDisconnect() {
		if (this._webSocket) {
			if (this._webSocket.readyState === StompSocketState.CONNECTING || this._webSocket.readyState === StompSocketState.OPEN) this._closeOrDiscardWebsocket();
		}
	}
	_closeWebsocket() {
	...
	dispose() {
		...
		else if (this._webSocket.readyState === StompSocketState.CONNECTING || this._webSocket.readyState === StompSocketState.OPEN) this._closeWebsocket();
	}
	_cleanUp() {
		this._connected = false;
		if (this._pinger) {
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/client.js
/**
* STOMP Client Class.
*
* Part of `@stomp/stompjs`.
	...
	async _connect() {
		...
		this._stompHandler = new StompHandler(this, webSocket, {
			...
			onWebSocketClose: (evt) => {
				...
				if (this.state === ActivationState.DEACTIVATING) this._changeState(ActivationState.INACTIVE);
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/stomp-config.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/stomp-headers.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/compatibility/heartbeat-info.js
/**
* Part of `@stomp/stompjs`.
*
* @internal
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/compatibility/compat-client.js
/**
...
//#endregion
//#region node_modules/@stomp/stompjs/esm6/compatibility/stomp.js
/**
...
//#endregion
export { ActivationState, Client, CompatClient, FrameImpl, Parser, ReconnectionTimeMode, Stomp, StompConfig, StompHeaders, StompSocketState, TickerStrategy, Versions };
