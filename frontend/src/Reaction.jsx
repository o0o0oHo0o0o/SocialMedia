...
import { ReactionApi } from "./ultis";
const Reaction = ({ userId, interactableId, targetType }) => {
  ...
  useEffect(() => {
    ...
    // }
    ReactionApi.fetchReaction(userId, interactableId)
      .then((data) => {
        setReactions(data);
      })
      .catch((err) => {
