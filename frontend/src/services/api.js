...
const api = {
  // Share a post
  sharePost: async ({ originalPostId, shareCaption }) => {
    const url = `${API_BASE}/shares`;
    const body = JSON.stringify({ originalPostId, shareCaption });
