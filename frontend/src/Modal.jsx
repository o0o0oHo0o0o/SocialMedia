...
function Modal({
  ...
  const handlePost = async () => {
    ...
    const postRequest = {
      ...
      postTopic: selectedFlair, // you can make this smarter
      location: "New York", // make dynamic later if you want
      userID: userId,
      // type=application/json is NOT needed here – it's handled by the header
    };
    ...
    try {
      const response = await PostApi.updateOrCreatePost(postId);
