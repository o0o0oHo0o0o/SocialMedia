  ...
  return (
    <div key={post.id} className="collection-card post-card">
      ...
      <div className="post-footer">
        ...
        <button className="highlight-item" onClick={() => setShareModalOpen(true)}>
          <svg
            rpl=""
            aria-hidden="true"
          ...
          <Modal onClose={() => setShareModalOpen(false)}>
            <div style={{ padding: 20 }}>
              ...
              <textarea
                ...
                placeholder="Viết chú thích cho chia sẻ (tuỳ chọn)"
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    await api.sharePost({ originalPostId: post.id, shareCaption });
                    setShareModalOpen(false);
                    setShareCaption("");
                    if (typeof onShareSuccess === 'function') onShareSuccess();
                    // Có thể reload lại feed hoặc cập nhật số share
                  } catch (e) {
              ...
              <button onClick={() => setShareModalOpen(false)}>Huỷ</button>
            </div>
          </Modal>
        )}
      </div>
